...
from MAMFNet_model import dehamer
...
def parse_args():
    ...
    # Data parameters
    parser.add_argument('-d', '--dataset-name', help='name of dataset',choices=['NH', 'dense', 'indoor','6k'], default='outdoor')
    parser.add_argument('-t', '--train-dir', help='training set path', default='./data/NH-HAZE/train_NH/')
    parser.add_argument('-v', '--valid-dir', help='test set path', default='./data/NH-HAZE/valid_NH/')
    parser.add_argument('--ckpt-save-path', help='checkpoint save path', default='')
    ...
    parser.add_argument('-e', '--nb-epochs', help='number of epochs', default=800, type=int)
...
# --- Load training data and validation/test data --- #
    ...
    # Transformer = Transformer(params, trainable=True)
    # Transformer.train(train_loader, valid_loader)
    model = dehamer(params, trainable=True)
